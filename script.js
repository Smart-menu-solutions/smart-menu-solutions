...
var translations = {
  'en': {
    ...
    'service_card_hub_desc': 'Guests order via QR code while waiter, kitchen, bar and cashier stay perfectly in sync in real time — less paper, fewer errors, faster service. Incl. till numbers on the bill.',
    ...
    'faq_a2': 'Choose a plan, pay securely online and upload your menu (PDF) and, if booked, your photos right afterwards.',
    ...
    'faq_q7': 'What happens after I pay?',
    ...
    'step3_desc': 'Pay online through our payment provider Stripe. There is no setup fee.',
    'step4_title': 'Upload your menu',
    'step4_desc': "Right after payment you upload your menu (PDF) and, if booked, your photos (ZIP). You can also do it later via the link in your confirmation email.",
    'step5_title': 'We build your digital menu',
    'step5_desc': 'We review your menu and turn it into your professional QR code menu, tailored to your business.',
    ...
    'order_info_hero_desc': 'Fill in your details and choose a plan. Right after payment you upload your menu — we\'ll take it from there.',
    ...
    'submit_order_btn': 'Continue to payment',
    ...
    'what_happens_next_desc': 'After payment you go straight to the upload page for your menu (PDF) and, if booked, your photos. We then contact you with the next steps.',
  ...
  'de': {
    ...
    'service_card_hub_name': 'Smart ServiceHub™',
    'service_card_hub_desc': 'Gäste bestellen per QR-Code, während Kellner, Küche, Bar und Kasse in Echtzeit synchron bleiben — weniger Zettelwirtschaft, weniger Fehler, schnellerer Service. Inkl. Kassen-Nr. auf der Rechnung.',
    ...
    'faq_a2': 'Wählen Sie einen Tarif, bezahlen Sie sicher online und laden Sie direkt danach Ihre Speisekarte (PDF) und ggf. Ihre Fotos hoch.',
    ...
    'faq_q7': 'Was passiert nach der Bezahlung?',
    ...
    'step3_title': 'Sicher bezahlen',
    'step3_desc': 'Sie bezahlen online über unseren Zahlungsdienstleister Stripe. Eine Einrichtungsgebühr gibt es nicht.',
    'step4_title': 'Speisekarte hochladen',
    'step4_desc': 'Direkt nach der Bezahlung laden Sie Ihre Speisekarte (PDF) und ggf. Ihre Fotos (ZIP) hoch. Das geht auch später über den Link in Ihrer Bestätigungs-E-Mail.',
    'step5_title': 'Wir erstellen Ihre digitale Speisekarte',
    'step5_desc': 'Wir prüfen Ihre Speisekarte und machen daraus Ihre professionelle QR-Speisekarte, maßgeschneidert für Ihr Unternehmen.',
    ...
    'order_info_hero_desc': 'Geben Sie Ihre Daten ein und wählen Sie einen Tarif. Direkt nach der Bezahlung laden Sie Ihre Speisekarte hoch – wir kümmern uns um den Rest.',
    ...
    'submit_order_btn': 'Weiter zur Bezahlung',
    ...
    'what_happens_next_desc': 'Nach der Bezahlung kommen Sie direkt zur Upload-Seite für Ihre Speisekarte (PDF) und ggf. Ihre Fotos. Danach melden wir uns mit den nächsten Schritten.',
...
var policyTranslations = {
  en: {
    ...
    renewal_hero_title:'Renew your <span class="accent">subscription</span>', renewal_hero_desc:'Confirm your details and choose your plan to continue for another year. If your menu has changed, you can upload the new one right after payment.', renewal_form_title:'Renew your subscription', renewal_step_plan_label:'02 / Confirm or change your plan', renewal_step_upload_label:'03 / Upload your current menu', renewal_label_upload_title:'Upload your menu PDF (new or unchanged)', renewal_submit_btn:'Renew now', renewal_summary_header:'Renewal summary', renewal_what_happens_next_desc:'Your subscription is renewed for another year as soon as payment succeeds.'
  },
  de: {
    ...
    renewal_hero_title:'Verlängern Sie Ihr <span class="accent">Abonnement</span>', renewal_hero_desc:'Bestätigen Sie Ihre Angaben und wählen Sie Ihren Plan, um ein weiteres Jahr fortzufahren. Falls sich Ihre Speisekarte geändert hat, laden Sie die neue direkt nach der Zahlung hoch.', renewal_form_title:'Abonnement verlängern', renewal_step_plan_label:'02 / Plan bestätigen oder ändern', renewal_step_upload_label:'03 / Aktuelles Menü hochladen', renewal_label_upload_title:'Menü-PDF hochladen (neu oder unverändert)', renewal_submit_btn:'Jetzt verlängern', renewal_summary_header:'Verlängerungsübersicht', renewal_what_happens_next_desc:'Ihr Abonnement wird um ein weiteres Jahr verlängert, sobald die Zahlung erfolgreich war.'
  }
};
...
Object.assign(translations.en, {
  ...
  privacy_intro_p3: 'We do not have a designated Data Protection Officer (DPO) but remain fully committed to addressing your privacy concerns. Should you have any questions or require further information about how we manage personal information, please contact us at <a href="mailto:info@smartmenusolutions.com">info@smartmenusolutions.com</a>.',
  ...
  privacy_control_p: 'We believe in transparency and giving you control over your personal information. You will always be informed of any significant changes to our sharing practices and, where applicable, given the option to consent to such changes. For any questions about how we share and disclose personal information, contact us at <a href="mailto:info@smartmenusolutions.com">info@smartmenusolutions.com</a>.',
  ...
  privacy_rights_exercise_p: 'To exercise any of these rights, contact us at <a href="mailto:info@smartmenusolutions.com">info@smartmenusolutions.com</a>. We will respond in accordance with applicable data protection laws and within the required timeframes. In some cases we may need to verify your identity to protect the security of your personal information.',
  ...
  privacy_requests_p: 'You may submit a request by emailing <a href="mailto:info@smartmenusolutions.com">info@smartmenusolutions.com</a>. We will compare the information you submit with our records to verify your request and respond in accordance with applicable requirements. To appeal a decision, contact us within 60 days of our response, including your original request, the date of our response, and why you believe the decision was incorrect.',
  ...
  privacy_contact_p: "If you have any questions or concerns about this privacy policy, please contact us at <a href=\"mailto:info@smartmenusolutions.com\">info@smartmenusolutions.com</a>. We're here to help."
});
Object.assign(translations.de, {
  ...
  privacy_intro_p3: 'Wir haben keinen benannten Datenschutzbeauftragten (DSB), setzen uns jedoch weiterhin uneingeschränkt für die Klärung Ihrer Datenschutzanliegen ein. Sollten Sie Fragen haben oder weitere Informationen dazu benötigen, wie wir personenbezogene Daten verwalten, kontaktieren Sie uns bitte unter <a href="mailto:info@smartmenusolutions.com">info@smartmenusolutions.com</a>.',
  ...
  privacy_rights_exercise_p: 'Um eines dieser Rechte auszuüben, kontaktieren Sie uns unter <a href="mailto:info@smartmenusolutions.com">info@smartmenusolutions.com</a>. Wir werden im Einklang mit den geltenden Datenschutzgesetzen und innerhalb der vorgeschriebenen Fristen antworten. In manchen Fällen müssen wir Ihre Identität überprüfen, um die Sicherheit Ihrer personenbezogenen Daten zu gewährleisten.',

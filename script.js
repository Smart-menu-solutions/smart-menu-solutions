...
var translations = {
  'en': {
    ...
    'feat_dish_photo': 'Every dish with its own photo (optional)',
  ...
  'de': {
    ...
    'feat_dish_photo': 'Jedes Gericht mit eigenem Foto (Optional)',

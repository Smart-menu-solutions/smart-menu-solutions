...
var translations = {
  'en': {
    ...
    'compare_hub_li2': 'Live kitchen & bar dashboards',
    ...
    'addon_sfm_mini': 'Smart Food Match',
    'addon_sfm_summary': 'Smart Food Match (optional)',
    'addon_analytics_mini': 'Weekly Analytics Report',
    'addon_analytics_summary': 'Weekly Analytics Report (optional)',
    ...
    'stats_paused_desc': 'The Weekly Analytics Report add-on isn\'t part of your active plan anymore, so there\'s nothing new to show here.',
    ...
    'stats_sfm_title': 'Smart Food Match',
  ...
  'de': {
    ...
    'compare_hub_li2': 'Live-Ansicht für Küche & Bar',
    ...
    'services_addon_heading': 'Add-on',
    'services_addon_sub': 'Erweitere jeden Smart-Menu-Plan mit optionalen Extras — von ansprechenden Gericht-Fotos über smarte Empfehlungen bis hin zu wöchentlichen Besucher-Einblicken. Füge genau das hinzu, was dein Business braucht, wann immer du es brauchst.',
    ...
    'addon_hub_pricing_desc': 'Die Live-Bestellplattform für dein Restaurant. Gäste bestellen per QR-Code, während Kellner, Küche, Bar und Kasse in Echtzeit perfekt synchron bleiben.',
    ...
    'addon_hub_feat_4': 'Vollständig in dein QR-Menü integriert',
    ...
    'faq_a2': 'Wähle einen Tarif, schließe deine Bestellung ab und schicke uns deine Speisekarte sowie deine Fotos.',
    ...
    'step4_desc': 'Wir prüfen deine hochgeladene Speisekarte und melden uns, falls wir deine Fotos oder weitere Branding-Details benötigen.',
    ...
    'addon_sfm_mini': 'Smart Food Match',
    'addon_sfm_summary': 'Smart Food Match (optional)',
    'addon_analytics_mini': 'Wöchentlicher Analyse-Bericht',
    'addon_analytics_summary': 'Wöchentlicher Analyse-Bericht (optional)',
    'addon_hub_mini': 'Smart ServiceHub',
    'addon_hub_summary': 'Smart ServiceHub (optional)',
    'stats_hero_title': 'Der wöchentliche Traffic deiner Speisekarte',
    'stats_hero_desc': 'Wie viele Gäste deine QR-Speisekarte gescannt haben, und welche Kategorien und Gerichte am häufigsten angesehen wurden.',
    'stats_error_desc': 'Dieser Link ist ungültig oder abgelaufen. Bitte kontaktiere uns, wir helfen gerne weiter.',
    'stats_paused_desc': 'Das Weekly-Analytics-Report-Addon ist aktuell nicht mehr Teil deines Tarifs, daher gibt es hier nichts Neues zu sehen.',
    'stats_paused_cta': 'Wieder aktivieren? Kontaktiere uns',
    ...
    'addons_hero_title': 'Deine Zusatzmodule verwalten',
    'addons_hero_desc': 'Füge jederzeit ein Feature hinzu - du zahlst nur den anteiligen Betrag für den Rest deines laufenden Abo-Jahres.',
    'addons_error_desc': 'Dieser Link ist ungültig oder abgelaufen. Bitte kontaktiere uns, wir helfen gerne weiter.',
    'addons_locked_desc': 'Dein Abo ist aktuell nicht aktiv, daher können gerade keine Zusatzmodule hinzugefügt werden. Bitte nutze den Verlängerungs-Link aus deiner E-Mail oder kontaktiere uns.',
    'addons_loading': 'Zusatzmodule werden geladen…',
    'addons_list_title': 'Verfügbare Zusatzmodule',
    'addon_prorate_note': 'Beim Hinzufügen wird nur der anteilige Betrag für den Rest deines laufenden Abo-Jahres berechnet - nicht ein volles Jahr. Ab der nächsten Verlängerung ist es automatisch mit dabei.',
...
var privacyGermanHtml = '<p class="updated">Gültig ab: 1. September 2026</p>' +
  '<h2>Einleitung und Unternehmens informationen</h2><p>Wir von Smart Menu Solutions möchten unsere Kunden und Kontakte bestmöglich betreuen. Dazu gehört der verantwortungsvolle Umgang mit personenbezogenen Daten, die über unsere Website und verbundene Kontakte erhoben werden.</p><p>Wir verwenden diese Daten, um die Nutzererfahrung zu verbessern, Anfragen zu beantworten, unsere Leistungen weiterzuentwickeln und notwendige Geschäftsabläufe wie Abrechnung und Kontoverwaltung durchzuführen.</p><p>Wir verarbeiten personenbezogene Daten mit größtem Respekt für Datenschutz und Sicherheit und halten die geltenden Vorschriften ein. Für Fragen kannst du uns unter <a href="mailto:smartmenusolutions@outlook.com">smartmenusolutions@outlook.com</a> kontaktieren.</p>' +
